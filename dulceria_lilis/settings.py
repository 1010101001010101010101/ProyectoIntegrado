...
CSRF_TRUSTED_ORIGINS = config('DJANGO_CSRF_TRUSTED', cast=Csv(), default='http://localhost,https://localhost')
...
SESSION_COOKIE_SECURE = False  # en producción con HTTPS = True
